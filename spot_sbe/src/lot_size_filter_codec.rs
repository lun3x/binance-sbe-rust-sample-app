...
pub use decoder::LotSizeFilterDecoder;
pub use encoder::LotSizeFilterEncoder;
...
pub mod encoder {
    ...
    pub struct LotSizeFilterEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for LotSizeFilterEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct LotSizeFilterDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for LotSizeFilterDecoder<'a> {
        #[inline]
