...
pub use decoder::TickerSymbolMiniResponseDecoder;
pub use encoder::TickerSymbolMiniResponseEncoder;

pub const SBE_BLOCK_LENGTH: u16 = 106;
pub const SBE_TEMPLATE_ID: u16 = 215;
...
pub mod encoder {
    ...
    pub struct TickerSymbolMiniResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for TickerSymbolMiniResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> TickerSymbolMiniResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct TickerSymbolMiniResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for TickerSymbolMiniResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> TickerSymbolMiniResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
