...
pub mod decoder {
        ...
        P: Decoder<'a> + Default,
    {
        ...
        #[inline]
        pub fn order_types(&self) -> OrderTypes {
            OrderTypes::new(self.get_buf().get_u16_at(self.offset + 5))
        }

        /// REQUIRED enum
        #[inline]
        pub fn iceberg_allowed(&self) -> BoolEnum {
            self.get_buf().get_u8_at(self.offset + 7).into()
        }

        /// REQUIRED enum
        #[inline]
        pub fn oco_allowed(&self) -> BoolEnum {
