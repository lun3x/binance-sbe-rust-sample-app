...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for WebSocketSessionLogoutResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> WebSocketSessionLogoutResponseEncoder<'a> {
...
pub mod decoder {
    ...
    impl<'a> WebSocketSessionLogoutResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
