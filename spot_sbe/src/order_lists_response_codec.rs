...
pub use decoder::OrderListsResponseDecoder;
pub use encoder::OrderListsResponseEncoder;

pub const SBE_BLOCK_LENGTH: u16 = 0;
pub const SBE_TEMPLATE_ID: u16 = 314;
...
pub mod encoder {
    ...
    pub struct OrderListsResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for OrderListsResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> OrderListsResponseEncoder<'a> {
        ...
        #[inline]
        pub fn order_lists_encoder(
            self,
            count: u32,
            order_lists_encoder: OrderListsEncoder<Self>,
        ) -> OrderListsEncoder<Self> {
            order_lists_encoder.wrap(self, count)
        }
    }

    #[derive(Debug, Default)]
    pub struct OrderListsEncoder<P> {
        parent: Option<P>,
        count: u32,
        index: usize,
        offset: usize,
    ...
    impl<'a, P> Encoder<'a> for OrderListsEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    pub struct OrderListsResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for OrderListsResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> OrderListsResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn order_lists_decoder(self) -> OrderListsDecoder<Self> {
            OrderListsDecoder::default().wrap(self)
        }
    }

    #[derive(Debug, Default)]
    pub struct OrderListsDecoder<P> {
        parent: Option<P>,
        block_length: usize,
        count: u32,
        index: usize,
    ...
    impl<'a, P> Reader<'a> for OrderListsDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
        ...
        P: Decoder<'a> + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='orderLists', referencedName='null', description='null', packageName='null', id=100, version=0, deprecated=0, encodedLength=19, offset=0, componentTokenCount=66, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
