...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for PercentPriceFilterEncoder<'a> {
        #[inline]
    ...
    impl<'a> PercentPriceFilterEncoder<'a> {
...
pub mod decoder {
    ...
    impl<'a> PercentPriceFilterDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn multiplier_up(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 1)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn multiplier_down(&self) -> i64 {
