...
pub mod encoder {
    ...
    pub struct WebSocketSessionStatusResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for WebSocketSessionStatusResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> WebSocketSessionStatusResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct WebSocketSessionStatusResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for WebSocketSessionStatusResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> WebSocketSessionStatusResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
