...
pub use decoder::Ticker24hMiniResponseDecoder;
pub use encoder::Ticker24hMiniResponseEncoder;
...
pub mod encoder {
    ...
    pub struct Ticker24hMiniResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for Ticker24hMiniResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> Ticker24hMiniResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct Ticker24hMiniResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for Ticker24hMiniResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Ticker24hMiniResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
